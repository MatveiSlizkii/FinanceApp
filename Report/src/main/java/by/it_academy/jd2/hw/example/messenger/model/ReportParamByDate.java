...
public class ReportParamByDate {
    ...
    private ReportParamByDate() {
    }

    public ReportParamByDate(List<UUID> accounts, LocalDateTime to, LocalDateTime from) {
        this.accounts = accounts;
        this.to = to;
        this.from = from;
    }

    public ReportParamByDate(Map<String, Objects> params) {
        //аккаунты
